...
| red_flags | 70.0000 | 0.1000 | Triggered red flags reduce confidence in the headline metrics. |
| overall | 73.9400 | 1.0000 | good business, too expensive |
...
| margin_deterioration_despite_sales_growth | True | medium | Revenue growth 14.9%; gross margin moved from 69.8% to 68.8%; net margin moved from 36.0% to 36.1%. |

## Investment Thesis

**Microsoft Corporation (MSFT)** currently screens as **good business, too expensive** with an overall score of **73.9/100**.

### Positives
- ROCE remains healthy at 29.7%.
- Leverage is conservative with debt-to-equity at 0.18x.
- Free cash flow stays positive at 71611000000 million USD.

### Concerns
- Enterprise value to sales remains elevated at 10.4x.
- Triggered red flags: receivables_growth_faster_than_revenue, margin_deterioration_despite_sales_growth.
...
## Output Files
- Scorecard CSV: `outputs\scorecards\msft_scorecard.csv`
- Scorecard JSON: `outputs\scorecards\msft_scorecard.json`
- Report: `outputs\reports\msft_analysis_report.md`
